...
def visionAPI(content: any, features=standardFeatures):
  ...
  imageFeatures = {
    "labels": jsonResponse['labelAnnotations'] if 'labelAnnotations' in jsonResponse else {},
    "objects": jsonResponse['localizedObjectAnnotations'] if 'localizedObjectAnnotations' in jsonResponse else {},
    "logos": jsonResponse['logoAnnotation'] if 'logoAnnotation' in jsonResponse else {}
  }
